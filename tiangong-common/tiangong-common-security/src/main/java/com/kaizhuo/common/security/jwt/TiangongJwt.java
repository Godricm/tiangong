package com.kaizhuo.common.security.jwt;
...
public class TiangongJwt {
    ...
    public String createToken(Object userId, Integer availableMinute){
        ...
        //TODO 添加claim附加信息【可直接解析】
        //用户信息：token中仅携带用户id，服务端要使用用户其他信息（如：姓名，所属单位等），由此id在后台数据库自行查找。
        // 因每次访问都需要查找用户信息，用户信息最好使用缓存，避免频繁查询数据库
        //TODO Redis缓存
    ...
    /**
     * 创建token并设置http header
     * @param userId
     * @param availableMinute
     */
