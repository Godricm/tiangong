package com.kaizhuo.tiangong.boot.modules.admin.aspect;

import com.alibaba.fastjson.JSONObject;
import com.kaizhuo.tiangong.boot.modules.admin.annotation.OpLog;
...
public class OpLogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.kaizhuo.tiangong.boot.modules.admin.annotation.OpLog)")
