package com.kaizhuo.tiangong.boot.admin.aspect;

import com.alibaba.fastjson.JSONObject;
import com.kaizhuo.tiangong.boot.admin.annotation.OpLog;
...
public class OpLogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.kaizhuo.tiangong.boot.admin.annotation.OpLog)")
