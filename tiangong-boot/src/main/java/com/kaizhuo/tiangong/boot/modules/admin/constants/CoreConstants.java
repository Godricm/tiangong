package com.kaizhuo.tiangong.boot.modules.admin.constants;
...
public class CoreConstants {
    ...
    public static final String ALIYUN_OSS_BUCKET_URL = "tiangong-resource.oss-cn-shenzhen.aliyuncs.com";
    ...
    public static final String ALIYUN_OSS_BUCKETNAME = "tiangong-resource";
